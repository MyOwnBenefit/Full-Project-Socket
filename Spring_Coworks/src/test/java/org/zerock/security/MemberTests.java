...
public class MemberTests {
	...
	/*
	 * @Test public void test() { String
	 * sql="insert into tbl_member(userid,userpw,username) values(?,?,?)";
	 * 
	 * for(int i=0;i<100;i++) { Connection con=null; PreparedStatement pstmt=null;
	 * 
	 ...
	 * try { pstmt.close();
	 * 
	 * }catch (Exception e2) { // TODO: handle exception } }if(con != null) { try {
	 * con.close(); }catch (Exception e2) { // TODO: handle exception } } } } }
	 */
	 ...
	 * if(i <80) {
	 * 
	 * pstmt.setString(1, "user"+i); pstmt.setString(2,"ROLE_USER"); //권한이름
	 * 
	 * }else if (i <90) {
	 * 
	 * pstmt.setString(1, "manager"+i); pstmt.setString(2,"ROLE_MEMBER");
	 * 
	 * }else {
	 * 
	 * pstmt.setString(1, "admin"+i); pstmt.setString(2,"ROLE_ADMIN");
	 * 
	 * }
	 * 
	 * pstmt.executeUpdate();
