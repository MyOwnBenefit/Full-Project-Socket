...
public class Download { 
	...
	String path = "E:\\download"; // 메세지를 받으면 호출된다. 

@OnMessage 
public void onMessage(Session session, String msg) throws IOException { // 클라이언트에서 fileName:파일명 형태로 파일 요청 
	...
	byte[] fileBytes = new byte[(int)file.length()];  // 파일로 연결된 스트림 생성
